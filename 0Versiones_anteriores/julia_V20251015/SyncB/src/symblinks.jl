#?module SymbLinksModule

#?using ..ConfigModule: Config
#?using ..LoggingModule: Logger
#?using FilePathsBase
#?using Glob
...
function buscar_enlaces_en_directorio(manager::SymbLinksManager, directorio::String, file::IO)
    try
