...
Dame las respuestas en Español concisas y claras.
Actúa cómo un experto programador.
Estructura bien el código.
Adaptar código a las mejores prácticas de Rust.
El código convertido tiene que ser completamente funcional.
...
Quiero Convertir completamente el script Bash a Rust. Adjuntado a continuación

Características a Implementar que están en el script bash:
- Mantener todas funcionalidades y características sin eliminar nada del código original.
- Todas las configuraciones que actualmente están en ficheros externos y variables globales integrarlas en un solo fichero de configuración tipo Toml.
- El fichero de exclusiones también se incluye en el fichero de configuración tipo Toml.
- El fichero de configuración tendrá un apartado separado para la sincronización en el host =feynman.rtva=.
- Sincronización bidireccional: Subir y Bajar con rsync.
- Manejo de enlaces simbólicos, los guarda en la subida y lo crea en la bajada.
...
- Soporte para Crypto: Directorio especial encriptado.
- Exclusiones configurables: Patrones en TOML y CLI.
- Modo dry-run: Simulación sin cambios verbose.
- Verificación de conectividad: Check de pCloud montado.
...
- Establecer permisos de ficheros y directorios indicados en el fichero de configuración.
- Registro detallado de enlaces simbólicos
- Notificaciones de sistema al finalizar (Linux/macOS)
- Estadísticas: Reporte detallado de la operación.
- Manejo de errores robusto.
- Todas las opciones de linea de comandos del script Base se implementaran integramente en Rust.
- Validar que todos los ficheros existen: fichero configuración, rutas, etc.
- Implementar en la ayuda ejemplos de uso de las opciones de linea de comando.
- Test de todos los tipos y funciones.
- Documentar tipos y funciones para un mejor entendimiento.
- Fichero readme detallado con todo lo necesario, como características, requisitos, instalación, configuración, variables de entorno, uso, ejemplos, etc.



========
Adjunto script a convertir a Rust =syncb.sh=
...
========
Ficheros de configuración a integrar en uno solo, tener en cuenta todas esta variables de configuración

fichero =syncb_directorios.ini=
#+begin_src bash
# Lista de directorio y ficheros a sincronizar  entre "feynman.sobremesa.dnf" y "$HOME"
#
# El problema esta en pCloud que no permite hacer sincronización y respardo del mismo directorio.
#
# Un elemento por línea, paths relativos a "$HOME" que debe ser igual en "feynman.sobremesa.dnf"


# Elementos urgentes
Documentos/personal/orgfiles
Documentos/proyectos/syncb
...
# Archivos y directorios en raíz
Plantillas
Vínculos
Documentos
Imágenes
...
# Trabajos temporales
tmp/codigo_temp_pruebas
#+end_src



==========
Fichero de configuracion =syncb_directorios_feynman.rtva.ini=
#+begin_src bash
# Lista de directorio y ficheros a sincronizar  entre "feynman.rtva.dnf" y "$HOME"
#
# El problema esta en pCloud que no permite hacer sincronización y respardo del mismo directorio.
#
# Un elemento por línea, paths relativos a "$HOME" que debe ser igual en "feynman.sobremesa.dnf"
...
# Proyectos
Documentos/proyectos/scripts_multiplataforma
...
# Trabajos Temporales
tmp/codigo_temp_pruebas/julia
#+end_src



====
Fichero de exclusiones actual =syncb_exlusiones.txt=
#+begin_src bash
